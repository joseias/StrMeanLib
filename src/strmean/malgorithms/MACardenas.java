    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (alpha < 1) {
                ...
                avgDistM.add(Double.toString(newMeanM.sumDist / iset.size()));
            ...
            median = bestE.sumDist / iset.size();
            ...
            median = bestM.sumDist / iset.size();
