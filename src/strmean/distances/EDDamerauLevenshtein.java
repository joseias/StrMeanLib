...
public  class EDDamerauLevenshtein extends EditDistance{
    ...
    public EDResult dEdition(Example ex, Example ey, boolean computeStatistics) {
        ...
        if (computeStatistics) {
            ...
            /**
             * JComment: Seria mejor implementar esto de modo que en los ejemplos se guarden las operaciones 
             * directamente de modo que no sea preciso referenciar a SymbolDif desde aqui y desde Example (es decir
             * que sea transparente el mecanismo de los indices de los simbolos)
            */
